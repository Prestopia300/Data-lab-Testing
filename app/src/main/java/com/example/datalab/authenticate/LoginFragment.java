...
//import com.example.datalab.main.MainMenuActivity; unused
...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Toast toast = Toast.makeText(getActivity(), "life... I am onCreateView()", Toast.LENGTH_LONG);
        toast.show();
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String email = emailText.getText().toString(); // was just one line
